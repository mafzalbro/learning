...
const createDarkPPTX = (path, mainDir) => {
    ...
    const themeColors = {
        ...
        overlay: { type: "solid", color: "#111111", transparency: 40 }, // Black overlay at 40% transparency
        overlay2: { type: "solid", color: "#222222", transparency: 40 }, // Black overlay at 40% transparency
        titleColor: "#e94560",                      // Vibrant accent for titles
        textColor: "#ffffff",                       // White text for content
        accentColor: "#e94560",                     // Accent color for decorative elements
    };
    ...
    jsonData.forEach((slideData, index) => {
        ...
        if (index === 0) {
            slide.background = { path: "./images/dark7.png" };
        } else {
